...
export default function Button({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex h-[4.7rem] w-[34rem] items-center justify-center rounded-[5px] text-body5 transition-all duration-200 disabled:bg-custom-gray-100 disabled:text-gray-400 ${
        variant === 'primary'
